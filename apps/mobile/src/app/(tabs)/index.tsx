...
export default function HomeScreen() {
  ...
  return (
    <Screen
      eyebrow={dateLabel}
      title={`Buenas tardes, ${displayName}`}
      subtitle="Tu música, ordenada y lista para tocar."
      right={
    ...
    >
      {next ? (
        <View>
          <LinearGradient
            colors={["#35151B", "#1B1717"]}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}
            style={styles.hero}
          >
            <View style={styles.heroTop}>
              <Text style={styles.heroEyebrow}>PRÓXIMO SERVICIO</Text>
            ...
            <View style={styles.heroBottom}>
              ...
              <View>
                <Text style={styles.heroNumber}>{next.peopleCount}</Text>
      ...
      <SectionTitle
        title={songs.length ? "Continúa practicando" : "Tu repertorio"}
        {...(songs.length
          ? {
        ...
        <Pressable onPress={() => router.push("/editor")} style={styles.emptyLibrary}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.insightCopy}>
              Puedes escribir letra, acordes o una secuencia para viento.
            </Text>
          </View>
