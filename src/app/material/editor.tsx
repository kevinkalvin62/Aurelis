...
export default function MaterialEditorScreen() {
  const { songId = '', songTitle = 'Canción', songKey = 'C' } = useLocalSearchParams<{ organizationId: string; songId: string; songTitle?: string; songKey?: string }>();
